...
void main() {
  ...
  group('Model Tree Test', () {
    ...
    testWidgets('should show circular menu', (WidgetTester tester) async {
      ...
      expect(find.byKey(Key('key_align_build_item')), findsNWidgets(2));
      expect(find.byKey(Key('key_transform_translate_build_item')), findsNWidgets(2));
      expect(find.byKey(Key('key_transform_scale_build_item')), findsNWidgets(2));
      expect(find.byKey(Key('key_align_build_menu_button')), findsNWidgets(1));
      expect(find.byKey(Key('key_circular_menu_item')), findsNWidgets(1));
      expect(find.byKey(Key('key_image_build_menu_button')), findsNWidgets(1));
      expect(find.byKey(Key('key_animate_build_item')), findsNWidgets(0));
    });
  });
}
