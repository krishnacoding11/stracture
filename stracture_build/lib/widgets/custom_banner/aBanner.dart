...
/// Specify how a [ABanner] was closed.
///
...
/// to know how a [ABanner] was closed can use this value.
///
/// Example:
///
/// ```dart
...
class ABanner extends MaterialBanner {
  /// Creates a [ABanner].
  ///
  ...
  /// The content of the [ABanner].
  ///
  /// Typically a [Text] widget.
  final Widget content;

  /// Style for the text in the [content] of the [ABanner].
  ///
  ...
  /// The (optional) leading widget of the [ABanner].
  ///
  /// Typically an [Icon] widget.
  final Widget? leading;

  /// The color of the surface of this [ABanner].
  ///
  ...
  /// The color of the shadow below the [ABanner].
  ///
  ...
  /// Creates an animation controller useful for driving a [ABanner]'s entrance and exit animation.
  ...
  ABanner withAnimation(Animation<double> newAnimation, { Key? fallbackKey }) {
    return ABanner(
      key: key ?? fallbackKey,
      content: content,
  ...
  @override
  State<ABanner> createState() => _ABannerState();
}

class _ABannerState extends State<ABanner> {
  ...
  @override
  void didUpdateWidget(ABanner oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final MaterialBannerThemeData defaults = theme.useMaterial3 ? BannerDefaultsM3(context) : _BannerDefaultsM2(context);
    ...
    final Widget buttonBar = Container(
      ///Belov code is commented due to not passing any actions
    ...
    return Hero(
      tag: '<MaterialBanner Hero tag - ${widget.content} - ${Random().nextInt(5000)}>',
...
@visibleForTesting
class BannerDefaultsM3 extends MaterialBannerThemeData {
  const BannerDefaultsM3(this.context)
      : super(elevation: 1.0);
