...
class AToggleSwitch extends StatefulWidget {
  const AToggleSwitch({
    Key? key,
    required this.value,
  ...
  @override
  _AToggleSwitchState createState() => _AToggleSwitchState();
}

class _AToggleSwitchState extends State<AToggleSwitch>
  ...
  @override
  void didUpdateWidget(AToggleSwitch oldWidget) {
